...
pub fn init_genesis_store<E: EthSpec, Hot: ItemStore<E>, Cold: ItemStore<E>>(
    ...
    *genesis_block.state_root_mut() = genesis_state
    ...
    let signed_block =
        SignedBeaconBlock::from_block(genesis_block, bls::Signature::empty());
    ...
    batch.push(PersistedBeaconChain { genesis_block_root: block_root }.as_kv_store_op(BEACON_CHAIN_DB_KEY));
