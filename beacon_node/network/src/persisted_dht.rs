...
pub fn load_dht<E: EthSpec, Hot: ItemStore<E>, Cold: ColdStore<E>>(
...
pub fn persist_dht<E: EthSpec, Hot: ItemStore<E>, Cold: ColdStore<E>>(
    store: Arc<HotColdDB<E, Hot, Cold>>,
    enrs: Vec<Enr>,
) -> Result<(), store::Error> {
...
pub fn clear_dht<E: EthSpec, Hot: ItemStore<E>, Cold: ColdStore<E>>(
    store: Arc<HotColdDB<E, Hot, Cold>>,
) -> Result<(), store::Error> {
