...
pub fn post_validator_monitor_metrics<T: BeaconChainTypes>(
    ...
    for id in ids {
                ...
                .get_monitored_validator(index)
        {
            ...
            let attestation_hit_percentage: f64 =
                ((100 * attestation_hits).checked_div(attestations)).unwrap_or(0) as f64;
            let head_attestations = attestation_head_hits + attestation_head_misses;
            let attestation_head_hit_percentage: f64 =
                ((100 * attestation_head_hits).checked_div(head_attestations)).unwrap_or(0) as f64;
